...
2. Writes extracted Markdown into a temporary document inbox.
3. Reuses the existing ScholarAIO document ingest pipeline.
...
1. Install and configure the backend services:
   - `qt-web-extractor` for URL/PDF extraction
